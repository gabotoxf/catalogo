            ...
            <tr v-for="user in users" :key="user.id_usuario" class="hover:bg-neutral-50/50 transition-colors group">
              ...
              <td class="px-6 py-3 text-right">
                <div class="flex justify-end gap-1">
                  ...
                  <button @click="deleteItem(user.id_usuario)" class="p-2 bg-red-50 text-red-500 hover:bg-red-500 hover:text-white rounded-lg transition-colors"><Trash2 :size="16" /></button>
                </div>
              </td>
            </tr>
          </tbody>
